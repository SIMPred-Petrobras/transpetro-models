...
Uso típico (com os erros de reconstrução que o automl já calcula):
    ...
    from transpetro_modelos.drift.detectors import default_detectors
    from transpetro_modelos.drift.benchmark import run_drift_benchmark
...
from transpetro_modelos.drift.detectors import BaseDriftDetector
