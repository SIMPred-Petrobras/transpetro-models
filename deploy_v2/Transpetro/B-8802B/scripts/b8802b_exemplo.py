"""
SIMPred — Inferência de anomalias do B-8802B.
...
EQUIP = "B-8802B"
EQUIP_DIR = Path(__file__).resolve().parent.parent      # .../Transpetro/B-8802B
BUNDLE_DIR = EQUIP_DIR / "modelos" / "model_2022-05-15_2022-07-21_VAE"
DADOS_DIR = EQUIP_DIR / "dados"
CSV_NOME = "data_2022-05-15_2022-07-21_raw.csv"
