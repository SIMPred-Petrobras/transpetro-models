"""
SIMPred — Inferência de anomalias do B-8802B-2025.
...
EQUIP = "B-8802B-2025"
EQUIP_DIR = Path(__file__).resolve().parent.parent      # .../Transpetro/B-8802B-2025
BUNDLE_DIR = EQUIP_DIR / "modelos" / "model_2025-01-01_2026-08-10_VAE"
DADOS_DIR = EQUIP_DIR / "dados"
CSV_NOME = "data_2025-01-01_2026-08-10_raw.csv"
